...
<Aside type="note">
In this guide, we use `python` and `pip` commands. Depending on your system configuration, `python` might refer to Python 2. If that's the case, you may need to use `python3` and `pip3` instead.
</Aside>
...
<Card>
### Step 1: Create a new file `hello.py`
```python
// hello.py
