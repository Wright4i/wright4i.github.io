...
_Example Template ([`template.xlsx`](../../../../assets/template.xlsx)):_
...
```bash
python3 generate_employee_report.py /tmp/template.xlsx /tmp/output.xlsx --data-start B6
```

_Example Output ([`output.xlsx`](../../../../assets/output.xlsx)):_
